...
parser = argparse.ArgumentParser(usage=textwrap.dedent(ArgHelp.usage))

# Commands
grp_cmd = parser.add_argument_group("Command")
...
# Options
grp_opt = parser.add_argument_group("Option")
...
# Parameters
grp_param = parser.add_argument_group("Parameter")
...
def main() -> None:
    """
    gallia-analyze: command line mode main function
    """
