...
class DatabaseHandler:
    ...
    def connect_db(self) -> bool:
        ...
        try:
            ...
            self.logger.error(f"DB connection failed: {g_repr(exc)}")
            return False
        return True
    ...
    def create_table(
        ...
        try:
            ...
            self.logger.error(f"DB creating table failed: {g_repr(exc)}")
            return False
        return True
    ...
    def clear_table(self, table_name: str) -> bool:
        ...
        try:
            ...
            self.logger.error(f"DB clearing table failed: {g_repr(exc)}")
            return False
        return True
    ...
    def delete_table(self, table_name: str) -> bool:
        ...
        try:
            ...
            self.logger.error(f"DB deleting table failed: {g_repr(exc)}")
            return False
        return True
    ...
    def get_df_by_query(self, sql: str, error_on: bool = True) -> pd.DataFrame:
        ...
        try:
            ...
            if error_on:
                self.logger.error(f"DB query failed: {g_repr(exc)}")
            return pd.DataFrame()
        if raw_df.shape[0] == 0:
            if error_on:
                self.logger.warning("no entry in database.")
            return pd.DataFrame()
        return raw_df
    ...
    def delete_run_db(self, table_name: str, run: int) -> bool:
        ...
        try:
            ...
            self.logger.error(f"deleting a run from DB failed: {g_repr(exc)}")
            return False
        return True
    ...
    def write_db(self, raw_df: pd.DataFrame, table_name: str) -> bool:
        ...
        try:
            ...
            self.logger.error(f"writing data to DB failed: {g_repr(exc)}")
            return False
        return True
