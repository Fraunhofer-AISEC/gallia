...
class XCPService:
    ...
    async def get_status(self) -> None:
        ...
        self.logger.info(tmp)
        self.logger.summary("XCP GET_STATUS -> OK")
    ...
    async def get_comm_mode_info(self) -> None:
        ...
        self.logger.info(tmp)
        self.logger.summary("XCP GET_COMM_MODE_INFO -> OK")
