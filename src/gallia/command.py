...
class Scanner(BaseCommand, ABC):
    ...
    def add_class_parser(self) -> None:
        ...
        group.add_argument(
            "--artifacts-dir",
            default=self.config.get("gallia.scan.artifacts_dir"),
            type=Path,
            help="Folder for artifacts",
        )
        group.add_argument(
            "--db",
            default=self.get_config_value("gallia.scan.db"),
            type=Path,
        ...
        group.add_argument(
            "--target",
            metavar="TARGET",
            default=self.get_config_value("gallia.scan.target"),
            type=TargetURI,
        ...
        group.add_argument(
            "--power-supply",
            metavar="URI",
            default=self.get_config_value("gallia.scan.power_supply"),
            type=PowerSupplyURI,
            help="URI specifying the location of the relevant opennetzteil server",
        )
        group.add_argument(
            "--power-cycle",
            default=self.get_config_value("gallia.scan.power_cycle"),
            const=5.0,
            nargs="?",
            type=float,
            help=(
        ...
        group.add_argument(
            ...
            default=self.get_config_value("gallia.scan.dumpcap", default=True),
...
class DiscoveryScanner(Scanner):
    ...
    def add_class_parser(self) -> None:
        ...
        self.parser.add_argument(
            "--timeout",
            type=float,
            default=self.get_config_value("gallia.scan.timeout", 0.5),
